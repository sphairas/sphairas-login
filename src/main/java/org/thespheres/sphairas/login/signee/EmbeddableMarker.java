...
public class EmbeddableMarker implements Marker, Serializable {
    ...
    public EmbeddableMarker(final Marker original) {
        this.convention = original.getConvention();
        this.markerId = original.getId();
        this.subset = original.getSubset();
    }

    public EmbeddableMarker(final String convention, final String markerId, final String subset) {
    ...
    public Marker getMarker() {
        Marker ret = MarkerFactory.find(convention, markerId, subset);
        if (ret == null) {
            ret = new AbstractMarker(convention, markerId, subset);
        }
        return ret;
    }
    ...
    public String toString() {
        return "EmbeddableMarker{" + "convention=" + convention + ", subset=" + subset + ", markerId=" + markerId + '}';
    }
